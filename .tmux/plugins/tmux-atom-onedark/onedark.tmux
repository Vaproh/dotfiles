...
main() {
  ...
  # variables.
  # shellcheck source=onedark-dark.tmuxtheme
  ...
  local show_user
  readonly show_user="#[fg=$thm_magenta,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_magenta]  #[fg=$thm_fg,bg=$thm_gray] #(whoami) "

  local show_host
  readonly show_host="#[fg=$thm_blue,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_blue]󰒋 #[fg=$thm_fg,bg=$thm_gray] #H "

  local show_date_time
  readonly show_date_time="#[fg=$thm_cyan,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_cyan]  #[fg=$thm_fg,bg=$thm_gray] $date_time "
